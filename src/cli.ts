...
program.name('tt').description("Tyler's Things CLI").version('1.0.0');
...
notes
    .command('tui')
    .description(
        'Interactive TUI to browse, search, and filter notes; prints selected note content and exits'
    )
    .action(async () => {
        try {
